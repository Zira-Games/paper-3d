...
class Scene {
  ...
  double widthToGL(double width) => width * 2 / size.width;
  double heightToGL(double height) => height * 2 / size.height;
  ...
  Matrix4 coordinateConversion(Matrix4 transformation) => PointerEvent.removePerspectiveTransform(
    toFlutterCoordinates *
    transformation *
    toOpenGlCoordinates
  );
